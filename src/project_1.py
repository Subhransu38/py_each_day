...
Create a Python script that ineracts with the user and generates a personalized self-introduction.

Your program should:
1. Ask the user for their name, age, city, profession, and favorite hobby.
2. Format this data into a warm, friendly paragraph of self-introdcution.
3. Print the final parageaph in a clean and readable format.
